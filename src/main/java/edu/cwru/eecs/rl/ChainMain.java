...
public class ChainMain {
    ...
    /**
     * Runs the chain domain with Lspi with a set of parameters that are known to work.
     * These parameters are from the paper and original Matlab implementation of Lspi.
     *
