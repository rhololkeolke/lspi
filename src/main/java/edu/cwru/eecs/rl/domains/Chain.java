...
public class Chain implements Simulator {
    ...
    /**
     * Constructs a new Chain domain instance.
     * The chain length is specified by numStates. The probability
     * of an action succeeding is specified by successProb. The distSeed
